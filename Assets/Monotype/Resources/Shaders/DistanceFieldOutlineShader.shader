Shader "Monotype/DistanceFieldOutline" {
    Properties {
        ...
        _UndefinedColor("Undefined Color", Color) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        Pass {
            ...
            v2f vert (appdata v)
            {
                ...
                o.uv = v.uv;
                if (v.color.r == _UndefinedColor.r && v.color.g == _UndefinedColor.g
                    && v.color.b == _UndefinedColor.b && v.color.a == _UndefinedColor.a)
                {
                    o.color = _ForegroundColor;
                }
                else
                {
                    o.color = v.color;
